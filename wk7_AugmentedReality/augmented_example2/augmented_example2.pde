...
//  
  ...
  cam0 = new GSCapture(this, 640, 480, "USB Video Class Video:1"); // initializing the webcam capture at a specific resolution (correct/possible settings depends on YOUR webcam)
